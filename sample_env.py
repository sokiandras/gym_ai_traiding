...
class SampleEnv(gym.Env):
    def __init__(self, known_data_number, getnews, getindexes, getreddit):
        ...
        if self.getnews == 1 and self.getindexes == 0 and self.getreddit == 0:
            shape = (7,
                     self.known_data_number)  # így az obs_space úgy fog kinézni, hogy az egyik dimenzió 6 (mivel 6 adatot kap meg a yf által letöltött adatokból - 1 időpontra 6 adat van (high, low, stb.), a másik dimenzió pedig a known_data_number (vagyis azok a sorok amikre visszalát)
