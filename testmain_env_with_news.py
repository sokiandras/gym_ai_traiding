...
# tanításhoz
if learning == 1:
    env = Env_with_news('AAPL','2024-03-25','2024-04-05', 100000, 2, '1h', getnews,"learn")
...
env_with_news = Env_with_news('AAPL','2024-04-08', '2024-04-10',100000,2,'1h', getnews,"backtest")
